...
def compare_two_matrixz_dist(matrix_1, matrix_2 ):
...
def seven_operation(matrix):
    ...
    score_list[0] = compare_two_matrixz_dist(matrix ,fliplr) 
    score_list[1] = compare_two_matrixz_dist(matrix ,flipud)  
    score_list[2] = compare_two_matrixz_dist(matrix ,ref_left_bot_right_top)
    score_list[3] = compare_two_matrixz_dist(matrix ,ref_left_top_right_bot)
    score_list[4] = compare_two_matrixz_dist(matrix ,matrix_rotate90)
    score_list[5] = compare_two_matrixz_dist(matrix ,matrix_rotate180) 
    score_list[6] = compare_two_matrixz_dist(matrix ,matrix_rotate270)
...
def dist_symmetry_score(matrix):
    ...
    print "here" + str(len(mini_matrix_data)) 
...
if __name__ == '__main__':
    ...
    print dist_symmetry_score(matrix )

    mini_matrix = get_mini_matrix(matrix, 0, 0 , 3 )

    flipud = np.flipud(mini_matrix)

    print type(mini_matrix)
    print "---" 
    print type(flipud)
    print ".."
    print mini_matrix == flipud 
